...
const Bank: React.FC = () => {
  ...
  console.log('log->statsOnpool', statsOnPool)
  return account && bank ? (
    <>
      <PageHeader
        icon="🏦"
...
const LPTokenHelpText: React.FC<{ bank: BankEntity }> = ({ bank }) => {
  ...
  const tombAddr = tombFinance.GUARDIAN.address;
  const tshareAddr = tombFinance.SHIELD.address;

  let pairName: string;
  let uniswapUrl: string;
  if (bank.depositTokenName.includes('GUARDIAN-FTM')) {
    pairName = 'GUARDIAN-FTM pair';

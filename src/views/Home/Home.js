    ...
    <Page>
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} sm={8}>
          <Paper>
            <Box p={4}>
              <h2>Welcome to Guardian Finance</h2>
              ...
              <p>
                ...
                Then stake your earned SHIELD in the Milkyway to earn more GUARDIAN!
              </p>
              { isMStart && !isMOver ? 
                <a href="/farm" style={{fontSize:"24px", fontWeight:"600"}}>Shield Reward Pools are live now!</a> : !isMStart ?
        ...
        <Grid container spacing={3}>
          <Grid item  xs={12} sm={12} style={{ margin: '12px', display: 'flex' }}>
            <Alert variant="filled" severity="warning" style={{width: '100%', background: '#b648bd'}}>
        ...
        <Grid item xs={12} sm={6}>
          <Card>
            <CardContent align="center">
              ...
              <Box mt={2}>
                <CardIcon>
                  <TokenSymbol symbol="GUARDIAN-FTM-LP" />
                </CardIcon>
              </Box>
              <Box mt={2}>
        ...
        <Grid item xs={12} sm={6}>
          <Card>
            <CardContent align="center">
              ...
              <Box mt={2}>
                <CardIcon>
                  <TokenSymbol symbol="SHIELD-FTM-LP" />
                </CardIcon>
              </Box>
              <Box mt={2}>

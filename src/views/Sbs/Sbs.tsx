...
const Sbs: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(tombFinance.GBOND, tombFinance.contracts.TShareSwapper.address);
        ...
        {!!account ? (
          <>
            <Route exact path={path}>
              <PageHeader icon={'🏦'} title="GBond -> Shield Swap" subtitle="Swap GBond to Shield" />
            </Route>
            <Box mt={5}>
                        ...
                        <CardContent>
                          <StyledCardContentInner>
                            ...
                            <StyledExchanger>
                              <StyledToken>
                                <StyledCardIcon>
                                  <TokenSymbol symbol={tombFinance.GBOND.symbol} size={54} />
                                </StyledCardIcon>
                              </StyledToken>
                            </StyledExchanger>
                            <Grid item xs={12}>

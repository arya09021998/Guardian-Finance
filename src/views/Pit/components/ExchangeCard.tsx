      ...
      <CardContent>
        <StyledCardContentInner>
          ...
          <StyledExchanger>
            <StyledToken>
              <StyledCardIcon>
                <TokenSymbol symbol={fromToken.symbol} size={100} />
              </StyledCardIcon>
              <Label text={fromTokenName} variant="secondary" />
            </StyledToken>
            <StyledExchangeArrow>
            ...
            <StyledToken>
              <StyledCardIcon>
                <TokenSymbol symbol={toToken.symbol} size={100} />
              </StyledCardIcon>
              <Label text={toTokenName} variant="secondary" />
            </StyledToken>
          </StyledExchanger>
